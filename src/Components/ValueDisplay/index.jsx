  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 w-full h-auto">
      <div className="text-center p-8">
        ...
        <h3 className="uppercase custom-font text-3xl font-bold mb-2 custom-text">Excelência</h3>
        <p className="text-center text-2xl ">
          Nosso objetivo é ajudar cada aluno a alcançar seu potencial máximo, fornecendo treinamento
          de qualidade e feedback individualizado.
        </p>
      </div>
      <div className="text-center p-8">
        ...
        <p className="text-center text-2xl">
          Valorizamos o respeito pelos outros e pela si próprio, promovendo uma cultura de harmonia
          e paz.
        </p>
      </div>
      <div className="text-center p-8">
        <FaRegCalendarCheck className="text-6xl  mx-auto mb-4 custom-font custom-text" />
        <h3 className="uppercase custom-font text-3xl font-bold mb-2 custom-text">disciplina</h3>
        <p className="text-center text-2xl">
      ...
      <div className="text-center p-8">
        ...
        <p className="text-center text-2xl">
          Acreditamos que a dedicação é a chave para o sucesso, e incentivamos nossos alunos a se
          dedicarem em suas jornadas pessoais e profissionais.
        </p>
      </div>
      ...
      <div className="text-center p-8">
        ...
        <p className="text-center text-2xl">
          Promovemos a saúde física e mental dos nossos alunos, incentivando a prática do judo como
      ...
      <div className="text-center p-8">
        ...
        <h3 className="uppercase custom-font text-3xl font-bold mb-2 custom-text">Comunidade</h3>
        <p className="text-center text-2xl">
          Promovemos a saúde física e mental dos nossos alunos, incentivando a prática do judo como
          um estilo de vida saudável.
        </p>
